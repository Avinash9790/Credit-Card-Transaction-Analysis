...
| Insight | Impact |
|---------|--------|
| **25-34 age group** spends 3x more than 55+ | Target millennials |
| **Entertainment** dominates weekend spending | Weekend cashback offers |
| **Mumbai customers** avg ₹15K/month | City-specific premium cards |
| **Q4 spending** peaks 40% above avg | Holiday season campaigns |
